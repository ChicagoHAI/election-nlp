...
def run_log_odds(corpus,corpus_name1,corpus_name2,ngram=1,stop_words=None):
    ...
    for corpus_pair in corpus_pairs:
        ...
        for ngram in [1,2]:
            for stop_words in [None,'english']:
                ...
                results = run_log_odds(corpus,corpus_name1,corpus_name2,ngram=ngram,stop_words=stop_words)
